...
namespace FundClear.Controllers
{
    public class FOF_ContractController : Controller
    {
        ...
        {
            var fOF_Contract = db.FOF_Contract.Include(f => f.Contract_Status).Include(f => f.FOF_Product).Include(f => f.Investor).Include(f => f.Sales_Branch).Include(f => f.Sales_Person);
        ...
        {
            ViewBag.Contract_status_id = new SelectList(db.Contract_Status, "Status_id", "状态");
        ...
        public ActionResult Create([Bind(Include = "Contract_id,Product_Id,购买金额,购买份额,赎回金额,Investor_id,投资人姓名,投资人身份证号,投资人开户银行,投资人银行账号,投资人银行账户名,SalesPerson_id,购买日期,Branch_id,Input_person_id,录入时间,Audit_person_id,审核时间,Contract_status_id")] FOF_Contract fOF_Contract)
        {
            ...
            ViewBag.Contract_status_id = new SelectList(db.Contract_Status, "Status_id", "状态", fOF_Contract.Contract_status_id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Contract_id,Product_Id,购买金额,购买份额,赎回金额,Investor_id,投资人姓名,投资人身份证号,投资人开户银行,投资人银行账号,投资人银行账户名,SalesPerson_id,购买日期,Branch_id,Input_person_id,录入时间,Audit_person_id,审核时间,Contract_status_id")] FOF_Contract fOF_Contract)
        {
            if (ModelState.IsValid)
            {
