...
namespace FundClear.Controllers
{
    ...
    public class FOF_ContractController : Controller
    {
        ...
        {
            var fOF_Contract = db.FOF_Contract.Include(f => f.FOF_Product).Include(f => f.Sales_Branch).Include(f => f.Sales_Person);
        ...
        public ActionResult Create([Bind(Include = "Contract_id,Product_Id,购买金额,购买份额,赎回金额,投资人姓名,投资人身份证号,投资人开户银行,投资人银行账号,投资人银行账户名,SalesPerson_id,购买日期,Branch_id,Input_person_id,录入时间,Audit_person_id,审核时间,合同状态")] FOF_Contract fOF_Contract)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Contract_id,Product_Id,购买金额,购买份额,赎回金额,投资人姓名,投资人身份证号,投资人开户银行,投资人银行账号,投资人银行账户名,SalesPerson_id,购买日期,Branch_id,Input_person_id,录入时间,Audit_person_id,审核时间,合同状态")] FOF_Contract fOF_Contract)
        {
            if (ModelState.IsValid)
            {
